...
class VerificationScreen extends Component {
  ...
  constructor(props) {
    ...
    this.state = {
      ...
      isOTPGenerated:
        this.props.route.params.isResetPassword === true ? false : true,
    };
  }
  ...
  _renderButtonView = () => {
    return (
        ...
        <GradientButton
          ...
          isOTPGenerated={this.state.isOTPGenerated}
          onPress={() => this._validateInputs()}
        >
          <Text style={styles.button}>
            {this.state.isResetPassword === true ? (
              this.state.isOTPGenerated === true ? (
                <Text style={{fontFamily:Constants.FONT_FAMILY.FONT_FAMILY_POPPINS_SEMI_BOLD}}>Reset</Text>
              ) : (
                <Text style={{fontFamily:Constants.FONT_FAMILY.FONT_FAMILY_POPPINS_SEMI_BOLD}}>Get OTP</Text>
              )
            ) : (
              <Text style={{fontFamily:Constants.FONT_FAMILY.FONT_FAMILY_POPPINS_SEMI_BOLD}}>Verify</Text>
            )}
          </Text>
        </GradientButton>
